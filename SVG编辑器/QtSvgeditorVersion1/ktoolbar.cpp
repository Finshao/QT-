	...
	, m_pSixBtn(NULL)
{
	...
	m_pFiveBtn = new KToolButton(KGlobalData::KDrawFlag::FiveDrawFlag, this);
	m_pSixBtn = new KToolButton(KGlobalData::KDrawFlag::SixDrawFlag, this);
	...
	m_pBtnGroup->addButton(m_pFiveBtn);
	m_pBtnGroup->addButton(m_pSixBtn);
	...
	m_pVLayout->addWidget(m_pFiveBtn);
	m_pVLayout->addWidget(m_pSixBtn);
